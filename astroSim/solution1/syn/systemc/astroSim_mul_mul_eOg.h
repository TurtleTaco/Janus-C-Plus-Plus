...
#ifndef __astroSim_mul_mul_eOg__HH__
#define __astroSim_mul_mul_eOg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(astroSim_mul_mul_eOg) {
    ...
    SC_CTOR(astroSim_mul_mul_eOg):  ACMP_smul_us_U ("ACMP_smul_us_U") {
